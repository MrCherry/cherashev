...
RSpec.describe PagesController, type: :controller do
  ...
  describe 'GET blog' do
    it 'assigns all pages as @pages' do
      blog_page = create(
        :page,
        category: Page.categories[:blog],
        state: Page.states[:published]
      )
      get :blog
  ...
  describe 'POST create' do
    describe 'with valid params' do
      it 'creates a new Page' do
        expect { post :create, page: valid_attributes }.to(
  ...
  describe 'DELETE destroy' do
    it 'safe_delete the requested page' do
      expect { delete :destroy, id: page.to_param }.to(
        change { Page.find(page.id).deleted? }.to(true)
      )
    end
